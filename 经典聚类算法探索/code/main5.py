...
from Set.set import *
from Model.myKMeans import myKMeans
from Data.dataloader import Dataloader
import time

args = parser.parse_args()

args.k_args.max_iters = 30
...
print(f"mykmeans 训练集上的聚类精度：{train_accuracy * 100:.3f}%")
print(f"mykmeans 测试集上的聚类精度：{test_accuracy * 100:.3f}%")
